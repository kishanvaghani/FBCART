   ...
   <body>
      ...
      <nav class="navbar navbar-light navbar-expand-lg bg-faded osahan-menu osahan-menu-top-4">
         <div class="container-fluid">
            <a class="navbar-brand" href="#"> <img src="<?= base_url(); ?>admindata2/images/logo.png" alt="logo"> </a>
            ...
            <div class="navbar-collapse" id="navbarNavDropdown">
               ...
               <?php if ("<?= base_url() ?>index.php/customer/home" OR "<?= base_url() ?>index.php/authenticate/login") {
                     ...
                     <li class="list-inline-item dropdown osahan-top-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right cart-dropdown">
                           ...
                           <div class="dropdown-cart-footer text-center">
                              ...
                              <a class="btn btn-sm btn-danger" href="#"> <i class="icofont icofont-shopping-cart"></i> VIEW
                              CART </a> <a href="#" class="btn btn-sm btn-primary"> CHECKOUT </a>
                           </div>
                        </div>
                     </li>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
               <ul class="navbar-nav mr-auto">
                   <li class="nav-item active">
                     <a class="nav-link" href="#"> <i class="icofont icofont-ui-home"></i> Home <span class="sr-only">(current)</span></a>
                  </li>
