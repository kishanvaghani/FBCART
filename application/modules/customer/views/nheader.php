   ...
   <body>
      <nav class="navbar navbar-light navbar-expand-lg bg-faded osahan-menu osahan-menu-top-4">
         <div class="container-fluid">
            <a class="navbar-brand" href="<?= base_url() ?>index.php/customer/home/home1"> <img src="<?= base_url(); ?>admindata2/images/logo.png" alt="logo"> </a>
        ...
        {
                  $c_id=($this->session->userdata['customer_logged_in']['c_id']);
                  $customer_name=($this->session->userdata['customer_logged_in']['customer_name']);
                  $email=($this->session->userdata['customer_logged_in']['email']);
                  $mobile=($this->session->userdata['customer_logged_in']['mobile']);
                     ...
                     <li class="list-inline-item dropdown osahan-top-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right cart-dropdown">
                           ...
                           <div class="dropdown-cart-footer text-center">
                              ...
                              <a class="btn btn-sm btn-danger" href="<?= base_url(); ?>index.php/customer/cart/show_cart"> <i class="icofont icofont-shopping-cart"></i> VIEW
                              CART </a> <a href="<?= base_url(); ?>index.php/customer/cart/show_cart" class="btn btn-sm btn-primary"> CHECKOUT </a>
                           </div>
                        </div>
                     </li>
                     <li class="list-inline-item dropdown osahan-top-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-list-design">
                           <a class="dropdown-item" href="<?= base_url() ?>index.php/customer/customer_profile"><i class="icofont icofont-ui-user"></i> My Profile</a>
                          
                           <a class="dropdown-item" href="<?= base_url() ?>index.php/customer/customer_profile"><i class="icofont icofont-heart-alt"></i> Wish List <span class="badge badge-success">6</span></a>
                           <a class="dropdown-item" href="<?= base_url() ?>index.php/customer/customer_profile/order_list"><i class="icofont icofont-list"></i> Order List</a>
                           <a class="dropdown-item" href="<?= base_url() ?>index.php/customer/customer_profile/order_list"><i class="icofont icofont-truck-loaded"></i> Order Status</a>
                           <a class="dropdown-item" href="<?= base_url() ?>index.php/customer/customer_profile"><i class="icofont icofont-paper"></i> Invoice A4</a>
                           <div class="dropdown-divider"></div>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
               <ul class="navbar-nav mr-auto">
                   <li class="nav-item active">
                     <a class="nav-link" href="<?= base_url() ?>index.php/customer/home/home1"> <i class="icofont icofont-ui-home"></i> Home <span class="sr-only">(current)</span></a>
                  </li>
                 
                  <li class="nav-item">
                     <a class="nav-link" href="#" aria-haspopup="true" aria-expanded="false">Men's Fashion </a>
                     
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="#"  aria-haspopup="true" aria-expanded="false"> Women's Fashion  </a>
                     
                  </li>
                  
                  <li class="nav-item">
                     <a class="nav-link" href="#"  aria-haspopup="true" aria-expanded="false">Kid's Fashion 
                     </a>
                     
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" target="_blank" href="<?= base_url()?>index.php/admin/register">Sell On FBCART</a>
                  </li> 
                  <li class="nav-item">
