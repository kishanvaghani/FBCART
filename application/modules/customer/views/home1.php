                           ...
                           <div class="h-100">
                              <div class="product-item">
                                 ...
                                 <div class="product-item-image">
                                    ...
                                    <a href="<?= base_url() ?>index.php/customer/home/cus_view"><img class="card-img-top img-fluid" src="<?= base_url(); ?>clothesimage/<?= $row->img?>" alt=""></a>
                                 </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-6 col-md-6 col-sm-6">
                  <a href="#">
                  <img src="<?= base_url(); ?>admindata2/images/offers/home2_banner_2.jpg" alt="">
                  </a>
               </div>
               <div class="col-lg-6 col-md-6 col-sm-6">
                  <a href="#">
                  <img src="<?= base_url(); ?>admindata2/images/offers/home2_banner_3.jpg" alt="">
                  </a>
               </div>
            </div>
         </div>
